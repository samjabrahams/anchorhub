...
_Note: If you'd like to make references to files that are in a different directory, make sure that you use the `-r` flag when processing your files. [See below](#recursive) for details._
