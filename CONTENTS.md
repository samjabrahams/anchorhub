...
* [Quick Start Guide](README.md#quick-start-guide)
	1. [Define your tags](README.md#1-define-your-tags)
...
* [AnchorHub's Command Line Interface](GUIDE.md#anchorhubs-command-line-interface)
	* [Usage](GUIDE.md#usage)
	* [Input](GUIDE.md#input)
	* [Output](GUIDE.md#output)
	* [Options](GUIDE.md#options)
		* [Help](GUIDE.md#help)
		* [Display version information](GUIDE.md#display-version-information)
		* [Parse all subdirectories, recursively](GUIDE.md#parse-all-subdirectories-recursively)
		* [Generate verbose output](GUIDE.md#generate-verbose-output)
		* [Overwrite input files](GUIDE.md#overwrite-input-files)
		* [Specify which file extensions to parse](GUIDE.md#specify-which-file-extensions-to-parse)
		* [Specify a wrapper syntax](GUIDE.md#specify-a-wrapper-syntax)
...
* [Goals](ABOUT.md#goals)
	* [Make using AnchorHub as simple as possible](ABOUT.md#make-using-anchorhub-as-simple-as-possible)
	* [Minimize "side-grading" the experience of users](ABOUT.md#minimize-side-grading-the-experience-of-users)
